...
class FrontendController extends Controller
{
    ...
    protected function settingsPayload(): array
    {
        ...
        return [
            ...
            'logo_light_url' => ($settings?->logo_light ?: $settings?->logo)
                                    ? Storage::url($settings->logo_light ?: $settings->logo) : null,
            'logo_dark'      => $settings?->logo_dark,
            'logo_dark_url'  => ($settings?->logo_dark ?: $settings?->logo)
                                    ? Storage::url($settings->logo_dark ?: $settings->logo)  : null,
