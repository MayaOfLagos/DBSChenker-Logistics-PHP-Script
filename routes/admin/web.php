...
Route::prefix('adminlogin')->group(function () {
    Route::controller(LoginController::class)->group(function () {
        ...
        Route::get('validate_admin', 'showLoginForm')->middleware('adminguest');
        ...
        // Password reset
        Route::get('forgot-password', 'showForgotForm')->name('adminpassword')->middleware('adminguest');
        Route::post('forgot-password', 'sendPasswordReset')->name('sendpasswordrequest')->middleware('adminguest');
        Route::get('reset-password', 'showResetForm')->name('adminresetform')->middleware('adminguest');
        Route::post('reset-password', 'resetPassword')->name('restpass')->middleware('adminguest');
    });
});
...
Route::middleware(['isadmin', '2fa'])->prefix('admin')->group(function () {
    ...
    Route::controller(HomeController::class)->group(function () {
        ...
        // CRM ROUTES
        Route::get('dashboard/customers', fn() => redirect()->route('customer')); // plural alias → singular
